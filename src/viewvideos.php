...
<body>
    <style>
        ...
        <div class="otherfiles">
            ...
            <center>
            <a href="http://localhost:3000/src/viewpublicvideos.php"><button class="publicbutton">View Public Interface</button></a>
                ...
                <a href="http://localhost:3000/src/viewppt.php"><button class="button">ppt</button></a>
...
<table border="2px">
  ...
  $sql = "SELECT video FROM videos WHERE userid = '$user'";
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        foreach ($files as $file) {
            ...
            if ($file_name == $name) {
                ...
                echo '<td><center>';
                echo '<a href="deletevideo.php?file_name='.$file_name.'"><font color = "red">Delete</font></a>';
                echo '</center></td>';
                echo '<td> <center><a href="pinsertvideo.php?file_name='.$file_name.'" onclick="return confirm(\'Are you sure you want to move the file to public interface?\');">move the file to public interface</a></center></td>';
                echo '</tr>';
                $i++;
            }
        }
